...
const SIGNALS: Array<{ level: number; patterns: RegExp[]; reason: string }> = [
  ...
  { level: 8, patterns: [/bandarmo|bandar/i, /akumulasi|distribusi/i, /broker/i, /net (buy|sell)/i, /aliran asing|net asing|foreign flow|beli asing|jual asing|aksi asing/i, /smart money/i, /gorengan/i, /likuiditas/i], reason: "bandarmologi / aliran dana" },
  ...
  { level: 6, patterns: [/margin|arus kas|payout|laba bersih/i, /kepemilikan|pemegang saham|komposisi saham|free float|porsi saham|shareholder|ownership|pengendali|treasury/i, /fundamental/i, /sehat (gak|ga|tidak|nggak|engga)/i, /laporan keuangan|lk\b/i, /kinerja keuangan/i, /hutang|utang/i, /profit|laba/i, /pendapatan|revenue/i, /ekuitas/i, /roe|roa|der/i, /dividen.*(aman|sehat)/i], reason: "fundamental menyeluruh" },
